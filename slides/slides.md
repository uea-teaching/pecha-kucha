...
I was very fortunate, before coming to the University to lecture, to work both for Disney Research and Facebook Reality labs.
...
The equation here is the Discrete Cosine Transform.
...
This is the constructor for a Neural Network to classify images of hand written digits.
...
These are not the semantic parameters I used as an example - but a deep compression of many images of faces.
...
**Motion**
We are very receptive to detecting motion.
...
The data scientist Edward Tufte analysed this slide...
:::
...
He found the complex hierarchy and de-emphasis of the most important points...

contributed to the engineers at NASA not recognising the possibility of damage to the re-entry shields of the Columbia.
